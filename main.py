...
""" 
Info: Monthly Report Creator is nearly done. You dont need to touch it, Also AddEmployee.py is works fine too.
The only problem is in Daily Attendance checker.
NOTE: it is already working, but needs to change and more functionality
"""
